...
ent-ComputerCargoOrdersEngineering = инженерный компьютер заказов
    .desc = Используется инженерным отделом для заказа материалов.
ent-ComputerCargoOrdersMedical = медицинский компьютер заказов
    .desc = Используется медицинским отделом для забора медикаментов и оборудования.
ent-ComputerCargoOrdersScience = научный компьютер заказов
    .desc = Используется научным отделом для заказа исследовательского оборудования.
ent-ComputerCargoOrdersSecurity = компьютер заказов охраны
    .desc = Используется службой безопасности для заказа спецсредств.
ent-ComputerCargoOrdersService = сервисный компьютер заказов
